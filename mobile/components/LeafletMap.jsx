...
// Dynamically resolve WebView on Native, fallback to null on Web
      ...
      <script>
        ...
        var destSvg = \`
          <svg width="30" height="42" viewBox="0 0 30 42" fill="none" xmlns="http://www.w3.org/2000/svg">
            <path d="M15 0C6.71573 0 0 6.71573 0 15C0 26.25 15 42 15 42C15 42 30 26.25 30 15C30 6.71573 23.2843 0 15 0ZM15 20.625C11.8934 20.625 9.375 18.1066 9.375 15C9.375 11.8934 11.8934 9.375 15 9.375C18.1066 9.375 20.625 11.8934 20.625 15C20.625 18.1066 18.1066 20.625 15 20.625Z" fill="#F44336"/>
          </svg>
        \`;
        ...
        var courierSvg = \`
          <svg width="30" height="42" viewBox="0 0 30 42" fill="none" xmlns="http://www.w3.org/2000/svg">
            <path d="M15 0C6.71573 0 0 6.71573 0 15C0 26.25 15 42 15 42C15 42 30 26.25 30 15C30 6.71573 23.2843 0 15 0ZM15 20.625C11.8934 20.625 9.375 18.1066 9.375 15C9.375 11.8934 11.8934 9.375 15 9.375C18.1066 9.375 20.625 11.8934 20.625 15C20.625 18.1066 18.1066 20.625 15 20.625Z" fill="#2196F3"/>
          </svg>
        \`;
        ...
        if ("${markerTitle}") {
          destMarker.bindPopup("<b>${markerTitle}</b>${markerDescription ? `<br>${markerDescription}` : ''}").openPopup();
        }
        ...
        ${onPress ? `
          map.on('click', function(e) {
            ...
            // Post message to React Native WebView or web parent
